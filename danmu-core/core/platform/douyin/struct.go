...
var newMessage = map[string]func() protoreflect.ProtoMessage{
	...
	"WebcastChatMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_ChatMessage{} },

	// 直播礼物赠送消息（用户送礼行为通知）
	// Live gift presentation message (notification of user gifting behavior)
	"WebcastGiftMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_GiftMessage{} },

	// 直播点赞消息（用户点击直播间点赞按钮）
	// Live like message (user clicks the like button in the live broadcast room)
	"WebcastLikeMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LikeMessage{} },

	// 直播间成员变动消息（加入/离开/关注等）
	// Live broadcast room member change message (join/leave/follow, etc.)
	"WebcastMemberMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_MemberMessage{} },

	// 直播社交互动消息（分享/关注/邀请等社交行为）
	// Live social interaction message (social behaviors such as sharing/following/inviting)
	"WebcastSocialMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_SocialMessage{} },

	// 直播间用户序列消息（维护在线用户列表顺序）
	// Live broadcast room user sequence message (maintains the order of the online user list)
	"WebcastRoomUserSeqMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomUserSeqMessage{} },

	// 粉丝团相关消息（入团、升级、粉丝任务通知）
	// Fans club related messages (joining the club, upgrading, fan task notifications)
	"WebcastFansclubMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_FansclubMessage{} },

	// 直播控制消息（禁言、清屏、设置管理员等操作）
	// Live broadcast control message (operations such as muting, clearing the screen, setting administrators)
	"WebcastControlMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_ControlMessage{} },

	// 表情聊天消息（带Emoji表情的弹幕）
	// Emoji chat message (danmaku with Emoji expressions)
	"WebcastEmojiChatMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_EmojiChatMessage{} },

	// 直播间统计消息（在线人数、互动数据、礼物收益）
	// Live broadcast room statistics message (number of online viewers, interaction data, gift revenue)
	"WebcastRoomStatsMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomStatsMessage{} },

	// 直播间通用通知消息（系统公告、活动提示）
	// Live broadcast room general notification message (system announcements, activity prompts)
	"WebcastRoomMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomMessage{} },

	// 小时榜入口消息（触发 hourly ranking list 显示）
	// Hourly ranking list entrance message (triggers the display of the hourly ranking list)
	"WebcastRanklistHourEntranceMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RanklistHourEntranceMessage{} },
	...
	"WebcastRoomRankMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomRankMessage{} },

	// 直播间内横幅消息（顶部滚动活动公告）
	// In-room banner message (scrolling activity announcements at the top)
	"WebcastInRoomBannerMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_InRoomBannerMessage{} },

	// 直播间数据同步消息（多端状态一致性更新）
	// Live broadcast room data synchronization message (consistent status updates across multiple devices)
	"WebcastRoomDataSyncMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomDataSyncMessage{} },

	// 盲盒临时状态消息（抽奖活动进度通知）
	// Lucky box temporary status message (notification of the progress of the lottery activity)
	"WebcastLuckyBoxTempStatusMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LuckyBoxTempStatusMessage{} },
	...
	"WebcastDecorationModifyMethod": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_DecorationModifyMessage{} },

	// 连麦观众K歌消息（多人连麦K歌场景）
	// Linked microphone audience KTV message (multi-person linked microphone KTV scenario)
	"WebcastLinkMicAudienceKtvMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LinkMicAudienceKtvMessage{} },

	// 直播流自适应消息（动态调整视频清晰度）
	// Live stream adaptation message (dynamically adjusts video clarity)
	"WebcastRoomStreamAdaptationMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomStreamAdaptationMessage{} },

	// 问答观众状态消息（互动答题活动参与情况）
	// Quiz audience status message (participation status in interactive quiz activities)
	"WebcastQuizAudienceStatusMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_QuizAudienceStatusMessage{} },

	// 热门聊天消息（高互动量弹幕聚合展示）
	// Hot chat message (aggregated display of high-interaction danmakus)
	"WebcastHotChatMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_HotChatMessage{} },

	// 热门直播间推荐消息（推送同类热门房间）
	// Hot live broadcast room recommendation message (pushes similar popular rooms)
	"WebcastHotRoomMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_HotRoomMessage{} },

	// 语音聊天消息（纯音频直播互动）
	// Voice chat message (pure audio live broadcast interaction)
	"WebcastAudioChatMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_AudioChatMessage{} },

	// 直播间媒体通知消息（重要事件弹窗提示）
	// Live broadcast room media notification message (pop-up prompt for important events)
	"WebcastRoomNotifyMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_NotifyMessage{} },

	// 盲盒活动消息（抽奖结果、奖励发放通知）
	// Lucky box activity message (lottery results, reward distribution notifications)
	"WebcastLuckyBoxMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LuckyBoxMessage{} },

	// 粉丝票更新消息（粉丝团专属积分变动）
	// Fan ticket update message (changes in fan club exclusive points)
	"WebcastUpdateFanTicketMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_UpdateFanTicketMessage{} },

	// 屏幕弹幕消息（全屏滚动特效弹幕）
	// Screen danmaku message (full-screen scrolling special effect danmaku)
	"WebcastScreenChatMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_ScreenChatMessage{} },

	// 通知特效消息（礼物连击、关注等动画效果）
	// Notification effect message (animation effects such as gift combos and follows)
	"WebcastNotifyEffectMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_NotifyEffectMessage{} },

	// 绑定礼物消息（任务奖励礼物发放）
	// Binding gift message (distribution of task reward gifts)
	"WebcastBindingGiftMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_BindingGiftMessage{} },
	...
	"WebcastLinkmicOrderSingScoreMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkmicOrderSingScoreMessage{}
	},
	...
	"WebcastLinkerContributeMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkerContributeMessage{}
	},
	...
	"WebcastLinkMicSendEmojiMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkMicSendEmojiMessage{}
	},
	...
	"WebcastLinkmicPlaymodeMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkmicPlaymodeMessage{}
	},
	...
	"WebcastActivityEmojiGroupsMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_ActivityEmojiGroupsMessage{}
	},
	...
	"WebcastLinkmicPlayModeUpdateScoreMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkmicPlayModeUpdateScoreMessage{}
	},
	...
	"WebcastLinkmicOrderSingMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkmicOrderSingMessage{}
	},
	...
	"WebcastLinkMicPositionMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkMicPositionMessage{}
	},
	...
	"WebcastLinkmicEnlargeGuestMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkmicEnlargeGuestMessage{}
	},
	...
	"WebcastLinkmicProfitMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkmicProfitMessage{}
	},
	...
	"WebcastPrivilegeScreenChatMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_PrivilegeScreenChatMessage{}
	},
	...
	"WebcastExhibitionChatMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_ExhibitionChatMessage{}
	},
	...
	"WebcastShelfTradeDataMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_ShelfTradeDataMessage{}
	},
	...
	"WebcastCustomizedCardMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_CustomizedCardMessage{}
	},
	...
	"WebcastAudienceEntranceMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_AudienceEntranceMessage{}
	},
	...
	"WebcastGroupLiveContainerChangeMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_GroupLiveContainerChangeMessage{}
	},
	// 直播间信息变更消息（房间名称/封面等更新）
	// Live broadcast room information change message (updates to room name/cover, etc.)
	"WebcastBackupSEIMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_BackupSEIMessage{}
	},
	// 直播间信息变更消息（房间名称/封面等更新）
	// Live broadcast room information change message (updates to room name/cover, etc.)
	"WebcastKtvMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_KtvMessage{}
	},
	...
	"WebcastDataLifeLiveMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_DataLifeLiveMessage{}
	},
	// 新抽奖活动消息（福袋/红包等活动通知）
	...
	"WebcastLotteryEventNewMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LotteryEventNewMessage{}
	},
	...
	"WebcastLinkMicBattleFinishMethod": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkMicBattleFinish{}
	},
	...
	"WebcastDecorationUpdateMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_DecorationUpdateMessage{}
	},
	// 直播收益游戏状态消息（收益互动游戏状态更新，如答题、竞猜等）
	"WebcastProfitGameStatusMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_ProfitGameStatusMessage{}
	},
	...
	"WebcastLinkMicBattleMethod": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkMicBattle{}
	},
	...
	"WebcastBattleTeamTaskMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_BattleTeamTaskMessage{}
	},
	...
	"WebcastBattleEndPunishMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_BattleEndPunishMessage{}
	},
	...
	"WebcastBattleEffectContainerMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_BattleEffectContainerMessage{}
	},
	...
	"WebcastTopEffectMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_TopEffectMessage{}
	},
	...
	"WebcastLinkSettingNotifyMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LinkSettingNotifyMessage{}
	},
	// 多人匹配对战消息（多人游戏匹配状态通知）
	// Multi-player match battle message (multiplayer game matching status notification)
	"WebcastBattleMultiMatchMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_BattleMultiMatchMessage{} },

	// KTV播放模式开始消息（KTV模式启动通知）
	// KTV play mode start message (notification of KTV mode activation)
	"WebcastKTVPlayModeStartMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_KTVPlayModeStartMessage{} },

	// KTV用户演唱热度消息（用户演唱实时热度值）
	// KTV user singing heat message (real-time singing heat value of users)
	"WebcastKTVUserSingingHotMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_KTVUserSingingHotMessage{} },

	// KTV歌手热度排名消息（歌手实时排名位置）
	// KTV singer heat ranking message (real-time singer ranking position)
	"WebcastKTVSingerHotRankPosMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_KTVSingerHotRankPosMessage{} },

	// 房间权限消息（直播间权限变更通知）
	// Room authority message (live room permission change notification)
	"WebcastRoomAuthMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomAuthMessage{} },

	// 传送门消息（特殊效果传送门触发通知）
	// Portal message (special effect portal trigger notification)
	"WebcastPortalMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_PortalMessage{} },

	// 消息删除通知（聊天消息删除操作通知）
	// Message deletion notification (chat message delete operation notification)
	"WebcastImDeleteMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_ImDeleteMessage{} },

	// 用户特权变更消息（用户权限等级变化通知）
	// User privilege change message (user privilege level change notification)
	"WebcastUserPrivilegeChangeMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_UserPrivilegeChangeMessage{} },

	// 房间验证消息（直播间安全验证通知）
	// Room verification message (live room security verification notification)
	"WebcastRoomVerifyMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomVerifyMessage{} },

	// 资产变动消息（用户虚拟资产变动通知）
	// Asset change message (user virtual asset change notification)
	"WebcastAssetMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_AssetMessage{} },

	// 流同步消息（多平台直播流状态同步）
	// Stream synchronization message (multi-platform live stream status synchronization)
	"WebcastSyncStreamMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_SyncStreamMessage{} },

	// 游戏CP主播推广消息（游戏合作主播推广信息）
	// Game CP anchor promotion message (game collaboration anchor promotion information)
	"WebcastGameCPAnchorPromoteInfoMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_GameCPAnchorPromoteInfoMessage{} },

	// 弹窗通知消息（系统级弹窗提示信息）
	// Toast notification message (system-level popup notification)
	"WebcastToastMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_ToastMessage{} },

	// 礼物投票消息（礼物投票活动通知）
	// Gift vote message (gift voting activity notification)
	"WebcastGiftVoteMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_GiftVoteMessage{} },

	// 连麦团队战消息（多人连麦对战状态通知）
	// Linkmic team battle message (multi-user linked streaming battle status notification)
	"WebcastLinkmicTeamfightMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LinkmicTeamfightMessage{} },

	// 商品变更消息（直播带货商品状态变更）
	// Product change message (live commerce product status change)
	"WebcastProductChangeMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_ProductChangeMessage{} },

	// 双赞榜首消息（双赞活动榜首用户通知）
	// Double-like top user message (top user notification for double-like activity)
	"WebcastDoubleLikeTopUserMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_DoubleLikeTopUserMessage{} },

	// 阳光日榜消息（地区阳光日榜排名通知）
	// Sun daily rank message (regional sun daily ranking notification)
	"WebcastSunDailyRankMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_SunDailyRankMessage{} },

	// 经纪人通知消息（直播经纪人系统通知）
	// Broker notification message (live streaming broker system notification)
	"WebcastBrokerNotifyMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_BrokerNotifyMessage{} },

	// 电商消息（直播电商相关操作通知）
	// Commerce message (live e-commerce related operation notification)
	"WebcastCommerceMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_CommerceMessage{} },

	// 角落达成消息（特定区域互动目标达成）
	// Corner reach message (specific area interaction goal achievement)
	"WebcastCornerReachMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_CornerReachMessage{} },

	// 游戏观众入口消息（游戏观战模式入口通知）
	// Game audience entrance message (game spectator mode entrance notification)
	"WebcastGameAncAudEntranceMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_GameAncAudEntranceMessage{} },

	// 游戏CP用户下载消息（游戏合作用户下载通知）
	// Game CP user download message (game collaboration user download notification)
	"WebcastGameCPUserDownloadMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_GameCPUserDownloadMessage{} },

	// 游戏状态消息（直播间游戏状态更新）
	// Game status message (live room game status update)
	"WebcastGameStatusMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_GameStatusMessage{} },

	// 高亮评论消息（精选评论突出显示通知）
	// Highlight comment message (featured comment highlighting notification)
	"WebcastHighlightComment": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_HighlightComment{} },

	// 横幅刷新消息（直播间横幅内容刷新）
	// Banner refresh message (live room banner content refresh)
	"WebcastInRoomBannerRefreshMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_InRoomBannerRefreshMessage{} },

	// 互动应用状态消息（第三方互动应用状态通知）
	// Interactive app status message (third-party interactive app status notification)
	"WebcastInteractOpenAppStatusMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_InteractOpenAppStatusMessage{} },

	// 直播电商消息（电商相关功能通知）
	// Live e-commerce message (e-commerce related feature notification)
	"WebcastLiveEcomMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LiveEcomMessage{} },

	// 抽奖结果消息（抽奖活动中奖结果通知）
	// Lottery result message (lottery activity result notification)
	"WebcastLotteryDrawResultEventMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LotteryDrawResultEventMessage{} },

	// 幸运盒结束消息（幸运盒活动结束通知）
	// Lucky box end message (lucky box activity end notification)
	"WebcastLuckyBoxEndMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LuckyBoxEndMessage{} },

	// 系统通知消息（平台级系统通知）
	// System notice message (platform-level system notification)
	"WebcastNoticeMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_NoticeMessage{} },

	// 奖品通知消息（用户获奖通知）
	// Prize notice message (user prize notification)
	"WebcastPrizeNoticeMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_PrizeNoticeMessage{} },

	// 拉流更新消息（视频流参数更新通知）
	// Pull stream update message (video stream parameters update notification)
	"WebcastPullStreamUpdateMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_PullStreamUpdateMessage{} },

	// 房间简介消息（直播间简介信息更新）
	// Room introduction message (live room introduction update)
	"WebcastRoomIntroMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_RoomIntroMessage{} },

	// 音频背景图消息（语音直播背景图更新）
	// Audio background image message (audio live background image update)
	"WebcastAudioBGImgMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_AudioBGImgMessage{} },

	// 连麦引导消息（连麦功能使用引导提示）
	// Linkmic guide message (linked streaming feature tutorial)
	"WebcastLinkMicGuideMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_LinkMicGuideMessage{} },

	// 阳光日榜地区排名消息（地区阳光日榜排名）
	// Sun daily region rank message (regional sun daily ranking)
	"WebcastSunDailyRegionRankMessage": func() protoreflect.ProtoMessage { return &dystruct.Webcast_Im_SunDailyRankMessage{} },
	"WebcastLuckyBoxRewardMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_LuckyBoxRewardMessage{}
	},
	"WebcastAssetEffectUtilMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_AssetEffectUtilMessage{}
	},
	"WebcastInteractEffectMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_InteractEffectMessage{}
	},
	"WebcastRankListAwardMessage": func() protoreflect.ProtoMessage {
		return &dystruct.Webcast_Im_RankListAwardMessage{}
	},
}
...
func MatchMethod(method string) (protoreflect.ProtoMessage, error) {
	...
	if createMessage, ok := newMessage[method]; ok {
